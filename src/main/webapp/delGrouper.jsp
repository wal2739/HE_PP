...
<body onload="delCheck();">
	...
	<main>
	    <div class="mainDiv">
	      <div class="div1">
	        <div class="div1_textArea"><h2>회원 삭제</h2></div>
	      </div>
	      <div class="div2">
	        <div class="div_2_back">
	        	<div class="div2_1">
	          <div class="div2_1_1">
	            <h2 id="div2_1_1_h2">회원 삭제 목록</h2>
	          </div>
	          <div class="div2_1_2">
			  	  <form action="delGrouperAct.do" onsubmit="return confirm('제명 후 다시 복구 할 수 없습니다. 계속 진행 하시겠습니까?');">
		          	<table id="inputTB">
			            <tr id="top_tr">
			            	<th></th>
			            	<th>회원명</th>
						...
						<%}%>
						<tr id="btm_tr">
				 			<th colspan="5" style="height: 30px; align-items: center;"><button id="sbt_btn" type="submit">제명</button></th>
				 		</tr>
						<%} %>
		            </table>			
		          </form>
