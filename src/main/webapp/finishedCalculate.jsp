...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
	List<WorkInfoForAssVO> list = (List)request.getAttribute("list");
    %>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="div2_1_2">
						<table id="inputTB">
							...
							<tr style="cursor: pointer;"
								onclick="show_receipt('<%=list.get(i).getWorkCode()%>')">
								<td><%=i+1 %></td>
							...
							<tr id="btm_tr">
								<th>
									<%if(list==null||list.size()==0){%> 작업 없음 <%}else { %> 총 작업 : <%=list.size() %>
									<%} %>
								</th>
								<th></th>
								<th></th>
